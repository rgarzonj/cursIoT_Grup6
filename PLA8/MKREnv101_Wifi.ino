...
void connectMqttServer()
{
    ...
    */
    ...
    mqttClient.subscribe("homie/mkrrelay/relay1/#");
    mqttClient.subscribe("homie/mkrrelay/relay2/#");
}
...
void messageReceived(String &topic, String &payload)
{
    ...
    if(topic.indexOf("/relay1/relay_on/set") > 0) {
        if (payload == "true") {
            digitalWrite(1, HIGH);
        } else {
            digitalWrite(1, LOW);
    ...
    if (topic.indexOf("/relay2/relay_on/set") > 0) {
        if (payload == "true") {
            digitalWrite(2, HIGH);
        } else {
            digitalWrite(2, LOW);
